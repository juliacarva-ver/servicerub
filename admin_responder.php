...
// verifica se quem esta carregando a pagina tem direito adm
...
$usuario = new usuario();
$usuario->buscarPorId($cliente->getUsuario_id());
...
<main class="container mt-5">
    ...
    <div class="card shadow p-4 mb-4">
        ...
        <p><strong>Status atual: </strong><?= $solicitacao->getClienteId() ?></p>
